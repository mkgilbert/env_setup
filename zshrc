...
# Custom zshrc based on machine type
# -------------------------------------
...
# credit for the SOURCE= part: https://stackoverflow.com/questions/9901210/bash-source0-equivalent-in-zsh
SOURCE=${(%):-%N}
